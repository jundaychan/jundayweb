...
| 模型 | 公司 | 特点 | 适合场景 |
|------|------|------|----------|
| GPT-5.5 | OpenAI | 综合最强，多模态 | 通用场景，复杂推理 |
| Claude Opus 4.8 | Anthropic | 长文本、代码、安全 | 深度分析，长文档处理 |
| Gemini 3.1 Pro | Google | 联网搜索，多模态强 | 需要最新信息的场景 |
...
├── 我需要最强的能力 → Claude Opus 4.8 或 GPT-5.5（需科学上网）
├── 我想做深度分析 → DeepSeek（推理强，便宜）
├── 我需要联网查最新信息 → Gemini 3.1 Pro
...
理解了 AI 是什么，你可以按照学习路径继续：

```
【你在这里】→ 为什么要用 → 怎么开始 → 学会对话 → 上手工具 → 搭建体系
```

- 下一篇：[这跟我的企业到底有什么关系？](/guide/why-ai-matters)
- 想直接上手试试？→ [AI 工具实测](/tools/index)
- 想让 AI 用你的数据回答？→ [RAG 知识库](/rag/index)
- 想让重复工作自动化？→ [工作流自动化](/workflow/index)
