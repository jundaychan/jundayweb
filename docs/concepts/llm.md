...
| 模型 | 上下文窗口 | 大约相当于 |
|------|-----------|----------|
| GPT-5.5 | 数十万 Token | 几十万字的资料 |
| Claude Opus 4.8 | 100 万 Token | 约 75 万字（一整套书） |
| Kimi | 256K Token | 一本 20 万字的书 |
| DeepSeek V4 | 100 万 Token | 约 75 万字 |
...
| 模型 | 公司 | 价格 | 最适合 |
|------|------|------|--------|
| **GPT-5.5** | OpenAI | $20/月 | 综合最强，多模态，英文场景 |
| **Claude Opus 4.8** | Anthropic | $20/月 | 综合智能第一，长文写作、代码、深度分析 |
| **Gemini 3.1 Pro** | Google | 免费/付费 | 联网搜索，与 Google 生态集成 |
